    ...
    <div className="prose">
      ...
      <div className="flex">
        ...
        <Image className={'rounded float-right ml-5'} src={'/images/LINCSearch_logo.png'} width={250} height={250} alt={'L2S2'}></Image>
          ...
          <br />
          <p>To learn more about the LINCS program and the L1000 assay:</p>
          <ul className='list-decimal'>
            <li>The L1000 data was generated by the Connectivity Map at the Broad Institute: <a className='underline cursor' href="https://clue.io/" target='_blank'>https://clue.io/</a>.</li>
            ...
            <p className='text-sm'>Evangelista, J. E., et al. (2022). SigCom LINCS: data and metadata search engine for a million gene expression signatures. Nucleic acids research, 50(W1), W697–W709.
            ...
            <p className='text-sm'>Pilarczyk, M., et al. (2022). Connecting omics signatures and revealing biological mechanisms with iLINCS. Nature communications, 13(1), 4678. <a href='https://doi.org/10.1038/s41467-022-32205-3' target="_blank" className="underline cursor">https://doi.org/10.1038/s41467-022-32205-3</a></p>
            ...
            d. L1000FWD <a href='https://maayanlab.cloud/l1000fwd/' target="_blank" className='underline cursor'>https://maayanlab.cloud/l1000fwd/</a> publication:<br></br>
            ...
            <a href=' https://doi.org/10.1093/bioinformatics/bty060' target="_blank" className='underline cursor'> https://doi.org/10.1093/bioinformatics/bty060</a><br></br>
            ...
            <p className='text-sm'>Duan, Q., et al. (2016). L1000CDS2: LINCS L1000 characteristic direction signatures search engine. NPJ systems biology and applications, 2, 16015–. <a href='https://doi.org/10.1038/npjsba.2016.15' target="_blank" className='underline cursor'>https://doi.org/10.1038/npjsba.2016.15</a></p>
          </ul>
          <br></br>
        </div>

      ...
      <div className="flex">
        ...
        <Image className={'rounded float-right ml-5'} src={'/images/LINCSearch_logo.png'} width={250} height={250} alt={'L2S2'}></Image>
          ...
          <ul className='list-decimal ml-4'>
            ...
            <p className='text-sm '>
            Subramanian, A., et al. (2017). A Next Generation Connectivity Map: L1000 Platform and the First 1,000,000 Profiles. Cell, 171(6), 1437–1452.e17. <a href="https://doi.org/10.1016/j.cell.2017.10.049" target="_blank">https://doi.org/10.1016/j.cell.2017.10.049</a>
            </p></li>

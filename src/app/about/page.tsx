    ...
    <div className="prose">
      ...
      <div className="flex">
        ...
        <Image className={'rounded float-right ml-5'} src={'/images/LINCSearch_logo.png'} width={250} height={250} alt={'L2S2'}></Image>
          ...
          <br />
          <p className='mb-2'>Please acknowledge L2S2 in your publications by citing the following reference: </p>
          <p>Marino GB, Evangelista JE, Clarke DJB, Ma’ayan A. L2S2: chemical perturbation and CRISPR KO LINCS L1000 signature search engine. <i>Nucleic Acids Res</i>. 2025; gkaf373. doi:<a className="underline cursor-pointer" href='https://doi.org/10.1093/nar/gkaf373' target='_blank'>10.1093/nar/gkaf373 </a></p>
          <br/>

...
export const metadata: Metadata = {
  title: 'LINCSearch',
  description: 'Search through 1,718,000 gene sets generated by the Library of Integrated Network-based Cellular Signatures (LINCS) program to find the most similar gene sets that match your query.',
  keywords: [
    'big data',
    'bioinformatics',
    'bone',
  ...
  metadataBase: new URL('https://lincsearch.maayanlab.cloud'),
  alternates: {
    canonical: '/',
  },
  openGraph: {
    ...
    siteName: 'LINCSearch',
    images: [{
      url: 'https://rummagene.com/images/LINCSearch_logo.png',
      width: 640,
      height: 671,
    }],
    locale: 'en_US',
